...
export const Models_FileHashesSchema = type({
  "SHA256?": "string",
  "CRC32?": "string",
  "BLAKE3?": "string",
  "AutoV3?": "string",
...
export type Models_FileHashes = typeof Models_FileHashesSchema.infer;

export const Models_FileSchema = type({
  id: "number.integer",
  sizeKB: "number",
  name: "string",
  type: "string",
  ...
  "hashes?": Models_FileHashesSchema,
  downloadUrl: "string.url",
});
export type Models_File = typeof Models_FileSchema.infer;

export const Models_ImageSchema = type({
  id: "number.integer",
  url: "string",
...
export type Models_Image = typeof Models_ImageSchema.infer;

export const Models_ModelVersionSchema = type({
  id: "number.integer",
  ...
  files: Models_FileSchema.array(),
  images: Models_ImageSchema.array(),
});
export type Models_ModelVersion = typeof Models_ModelVersionSchema.infer;

export const Models_ModelSchema = type({
  id: "number.integer",
  name: "string",
  ...
  tags: "string[]",
  modelVersions: Models_ModelVersionSchema.array(),
});
export type Models_Model = typeof Models_ModelSchema.infer;

export const Models_ResponseSchema = type({
...
export type Models_Response = typeof Models_ResponseSchema.infer;

export const Models_RequestOptsSchema = type({
...
export type Models_RequestOpts = typeof Models_RequestOptsSchema.infer;
